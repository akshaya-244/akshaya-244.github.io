...
const Projects = () => {
    const projects = [
        ...
        },
        {
            img: "/plinko.png",
            title: "Plinko Game",
            description: "Constructed MVP exploiting React, Typescript completing project within 2 weeks and achieving 90% code coverage through unit tests, demonstrating rapid prototyping skills and strong foundation in TypeScript fundamentals",
        ...
        },
        {
            img: "/medium.png",
            title: "Medium Clone",
            description: "Passionately engineered Medium clone as a minimum viable product integrating TypeScript, Prisma, and Hono, with Cloudflare Workers for backend deployment, Vercel for frontend within 6-week timeline, receiving positive feedback from 80% of testers.",
        ...
        },
        {
            img: "/memory-game.png",
            title: "Memory Game",
            description: "A classic memory game built with HTML, CSS, and JavaScript, where players flip over tiles to reveal matching pairs and test their memory skills.",
        ...
        },
        {
            img: "/omni.png",
            title: "Omnifoods",
            description: "A CSS showcase website designed and developed to demonstrate my skills in creating visually appealing and responsive web experiences.",
        ...
        },
        {
            img: "/pig.png",
            title: "Pig Game",
            description: "A simple yet addictive dice game built with HTML, CSS, and JavaScript, where players take turns rolling dice to score points, trying to avoid the dreaded pig out to win the game!",
            techStack: "HTML5, CSS3, Javascript",
    ...
    return <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
            {projects.map((project, index) => (
                <Card key={index} className="w-full max-w-[550px] mx-auto hover:border-red-300 border-white">
                    <CardHeader>
                        <CardTitle>
                            <Image src={project.img} alt={project.title} width={500} height={400} className="rounded-md" />
                            <div className="mt-4">{project.title}</div>
                        </CardTitle>
                        <CardDescription><div className="py-4">{project.description}</div></CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="flex">
                    ...
                    <CardFooter className="flex justify-between">
                        <Link href={project.livePreview} className="flex items-center text-blue-500 hover:underline">
                            <Link2 className="mr-2" /> Live Preview
                        </Link>
                        <Link href={project.githubLink} className="flex items-center text-white hover:underline">
