    ...
    <div className="bg-black text-white border-b border-white">
      <div className="flex py-6 justify-between items-center mx-16">
        ...
        <div className=" hidden md:flex gap-6 ">
          ...
          <Link
            href="https://github.com/akshaya-244"
          ...
          <Link
            ...
            href="https://www.linkedin.com/in/24-akshaya-mohan/"
          >
            <LinkedinIcon />
          </Link>
          <Link
            className="hover:text-green-500"
            href="https://drive.google.com/file/d/1mpxL6dfVgJRjFvC4kMwfXX3o3CDjf2u5/view?usp=sharing"
          >
            <FileText />
          </Link>
        </div>
