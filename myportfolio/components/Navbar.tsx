    ...
    <div className="bg-black text-white">
      <div className="flex py-6 justify-between items-center mx-16">
        ...
        <div className="hidden md:flex w-1/4 justify-between">
          ...
          <Link href="https://github.com/akshaya-244">
            <Github />
          </Link>
          <Link href="https://www.linkedin.com/in/24-akshaya-mohan/">
            <LinkedinIcon />
          </Link>
          <Link href="https://drive.google.com/file/d/1z68TaOC7lz4ml897Ibt76gkJp6_7XeHR/view?usp=sharing">
            <FileText />
          </Link>
          <Link href="">
            <Mail />
